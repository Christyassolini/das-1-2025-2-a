...
É uma arquitetura utilizada para organizar melhor projeto, dividindo suas responsabilidades.
...
**@autowired**
É usado para diminuir acoplamento, evitando que uma classe implemente em outra classe.
